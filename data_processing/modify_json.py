import json
import pandas as pd
from config import BAK, MAG, ABOUT, FULL_NAME


NAME = '../data/programs-info'
...
with open(f'../data/raex.json', 'r', encoding='utf-8') as file:
    raex = json.load(file)
...
df.to_json(f'../data/{NAME}-lines.json', orient='records', force_ascii=False, indent=4)
